                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ session("name")." ".session("apellido") }}" required autocomplete="name" autofocus readonly>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ci" type="text" class="form-control @error('email') is-invalid @enderror" name="ci" value="{{ session("ci") }}" required autocomplete="email" readonly>
