...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="{{ route('editUser.update', ['id' => $user]) }}" method="post">
        @method('put')
        @csrf
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="name" placeholder="Nombre Completo" value="{{old('name',$user->name)}}">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" name="ci" placeholder="Cédula" value="{{old('ci',$user->ci)}}" readonly>
